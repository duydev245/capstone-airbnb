...
const SearchBar = () => {
    ...
    return (
        <>
            {contextHolder}
            <Row gutter={24} style={{ margin: 'auto', padding: '0' }} className=" container seachbar border-2 shadow-xl border-gray-400 bg-white xs:mb-8 xs-plus:mb-8 xs:rounded-b-lg xs-plus:rounded-b-lg md:rounded-lg w-full">
